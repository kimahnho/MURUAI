...
| 이벤트 | 시점 |
|--------|------|
| `[AI템플릿] 감정추론 텍스트 생성` | 랜딩 텍스트 생성 완료 후 |
| `[AI템플릿] 감정추론 텍스트 확인 진입` | 포커스 모드 사이드바 마운트 시 |
| `[AI템플릿] 감정추론 이미지 생성 시작` | 이미지 생성 버튼 클릭 시 |
| `[AI템플릿] 감정추론 카드 성별 변경` | 카드 성별 토글 성공 후 |
| `[AI템플릿] 감정추론 이미지 생성 완료` | 이미지 생성 성공 후 |
| `[AI템플릿] 감정추론 확정` | 확정하기 클릭 시 |
