...
const UnauthorizedView = ({
  ...
  return (
    <div className="flex min-h-[70vh] w-full items-center justify-center px-6 py-12">
      <div className="flex w-full max-w-lg flex-col gap-5 rounded-3xl border border-slate-200 bg-white-100 p-8 shadow-sm">
        ...
        <div className="rounded-2xl border border-slate-200 bg-black-5 px-4 py-3 text-14-regular text-black-70">
