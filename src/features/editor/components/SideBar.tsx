...
import UploadContent from "./detail_content/UploadContent";
import AACContent from "./detail_content/AACContent";
import EmotionContent from "./detail_content/EmotionContent";
import ElementContent from "./detail_content/ElementContent";
import ImageLibraryContent from "./detail_content/ImageLibraryContent";
import TextContent from "./detail_content/TextContent";
import FontContent from "./detail_content/FontContent";
import TemplateContent from "./detail_content/TemplateContent";
import DesignContent from "./detail_content/DesignContent";
