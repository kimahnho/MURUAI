...
const PromptHeroSection = ({
  ...
  return (
    <section className="flex flex-col items-center w-full px-4 pt-12 pb-10 bg-linear-to-b from-[#FDFCFF] to-[#f5f3ff] md:px-10 md:pt-24 md:pb-16">
      <div className="flex flex-col items-center max-w-3xl w-full gap-6 text-center md:gap-8">
        {/* 안내 뱃지 */}
        <span className="inline-flex items-center gap-1.5 rounded-full border border-primary-200 bg-white/60 backdrop-blur-sm px-4 py-1.5 text-13-bold text-primary">
        ...
        <div className="flex flex-col items-center gap-12 pt-10 w-full md:gap-16 md:pt-14">
            ...
            <div className="relative w-full max-w-[500px] mx-auto aspect-[1/1.414] rounded-3xl overflow-hidden shadow-[0_12px_40px_-12px_rgba(124,58,237,0.10)] border border-primary-200 bg-white group hover:shadow-[0_20px_60px_-15px_rgba(124,58,237,0.14)] transition-shadow duration-500">
              ...
              {previewPage > 1 && (
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-10 h-10 rounded-full bg-white/90 shadow-md text-primary hover:bg-primary-100 transition-all opacity-0 group-hover:opacity-100 cursor-pointer"
                >
              ...
              {previewPage < 3 && (
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-10 h-10 rounded-full bg-white/90 shadow-md text-primary hover:bg-primary-100 transition-all opacity-0 group-hover:opacity-100 cursor-pointer"
                >
          ...
          <div className="flex flex-col items-center gap-4 w-full md:gap-5">
            ...
            <div className="relative w-full max-w-2xl rounded-2xl overflow-hidden shadow-[0_8px_24px_-8px_rgba(124,58,237,0.08)] border border-primary-200">
              <img
