...
const PALETTE_SECTIONS: { title: string; items: PaletteItem[] }[] = [
  {
    title: "기본 컴포넌트",
    items: [
      { type: "header_instruction", icon: "📝", iconBg: "bg-blue-50", name: "지시문", desc: "제목 + 활동 안내", badge: "text" },
      { type: "reward_tracker", icon: "⭐", iconBg: "bg-yellow-50", name: "보상 트래커", desc: "스티커/별 칸", badge: "text" },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "grid_NxM", icon: "⊞", iconBg: "bg-purple-50", name: "그리드", desc: "단어카드/이미지 배열" },
    ],
  },
  {
    title: "어휘 · 읽기 · 한글",
    items: [
      ...
      { type: "coloring_area", icon: "🎨", iconBg: "bg-rose-50", name: "색칠 영역", desc: "라인아트 색칠 활동", badge: "new" },
    ],
  },
  {
    title: "기록",
